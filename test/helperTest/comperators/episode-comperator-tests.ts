...
describe('Episode comperator | Full test', () => {
    ...
    describe('season tests', () => {
        ...
        it('should compare seasons right (missing providerB season)', async () => {
            const resultA = await EpisodeComperator['isEpisodeSameSeason'](aEpisode, bEpisode, 1, undefined, 1);
            strictEqual(resultA, true);
        });
         it('should compare seasons right (missing providerA season)', async () => {
            const resultA = await EpisodeComperator['isEpisodeSameSeason'](aEpisode, bEpisode, undefined, 1, 1);
            strictEqual(resultA, true);
         });
         it('should compare seasons right (missing all provider season)', async () => {
            const resultA = await EpisodeComperator['isEpisodeSameSeason'](aEpisode, bEpisode, undefined, undefined, 1);
            strictEqual(resultA, true);
         });
         it('should compare seasons right (missing series season)', async () => {
            const resultA = await EpisodeComperator['isEpisodeSameSeason'](aEpisode, bEpisode, 1, 1, undefined);
            strictEqual(resultA, true);
         });
         it('should compare seasons right (missing provider season and series season)', async () => {
            const resultA = await EpisodeComperator['isEpisodeSameSeason'](aEpisode, bEpisode, undefined, undefined, undefined);
            strictEqual(resultA, true);
         });
         it('should compare seasons false', async () => {
            const resultA = await EpisodeComperator['isEpisodeSameSeason'](aEpisode, bEpisode, undefined, undefined, 2);
            strictEqual(resultA, false);
         });
         it('should compare seasons right (no missing seasons)', async () => {
            const resultA = await EpisodeComperator['isEpisodeSameSeason'](aEpisode, aEpisode, 1, 1, 1);
            strictEqual(resultA, true);
         });
         it('should compare seasons false (false provider season)', async () => {
            const resultA = await EpisodeComperator['isEpisodeSameSeason'](aEpisode, bEpisode, 1, 2, 1);
            strictEqual(resultA, false);
         });
