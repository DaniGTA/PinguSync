...
describe('Provider Helper Test', () => {
    ...
    beforeEach(() => {
        ProviderList['loadedListProvider'] = ProviderList['loadProviderList']([
            KitsuProvider,
            MalProvider,
            TraktProvider,
        ] as Array<new () => ListProvider>)
    ...
    test('should sort provider that need updates right (1/3)', () => {
        ...
        // tslint:disable-next-line: no-string-literal
        providersThatNeedsAUpdate.sort((a, b) =>
            ProviderListHelper['sortProvidersThatNeedUpdates'](a, b, currentProviderData)
        )
