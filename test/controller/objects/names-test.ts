...
describe('Name | Season + lang detection', () => {
    ...
    test('should detect no romaji name', async () => {
        const names = [];
    ...
    test('should return romaji name', async () => {
        const names = [];
        names.push(new Name('テスト', 'jap'));
    ...
    test('should not sort out', async () => {
        let names: Name[] = [];
