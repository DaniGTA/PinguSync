...
describe('Provider: TVMaze | Test runs', () => {
    beforeEach(() => {
        ProviderList['loadedListProvider'] = ProviderList['loadProviderList']([TVMazeTestProvider] as Array<
            new () => ListProvider
        >)
        ProviderList['loadedInfoProvider'] = ProviderList['loadProviderList']([TVMazeProvider] as Array<
            new () => InfoProvider
        >)
