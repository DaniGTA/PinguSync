...
export default class EregnyAnimeRelationsManager {
    ...
    private static readonly DATABASE_URL = 'https://raw.githubusercontent.com/erengy/anime-relations/master/anime-relations.txt';
    ...
    private static async downloadDatabase(): Promise<any> {
        const res = await WebRequestManager.request({ uri: EregnyAnimeRelationsManager.DATABASE_URL });
