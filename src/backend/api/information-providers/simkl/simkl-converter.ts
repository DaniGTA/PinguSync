...
export default class SimklConverter {
    ...
    public async convertSimklTextSearchResultsToMultiProviderResults(
        searchResults: ISimklTextSearchResults[],
        type: MediaType
    ...
    public async convertFullAnimeInfoToProviderLocalData(
        response: ISimklFullInfoAnimeResponse,
        episodeResponse: ISimklEpisodeInfo[]
    ): Promise<MultiProviderResult> {
        ...
        const mprList = new MultiProviderResult(
            new ProviderLocalDataWithSeasonInfo(provider),
            ...this.convertAnimeIdsToProviders(response.ids)
        )
        return mprList
    }

    public async convertFullMovieInfoToProviderLocalData(
        response: ISimklFullInfoMovieResponse
    ): Promise<MultiProviderResult> {
        const provider = new ListProviderLocalData(response.ids.simkl, SimklProvider.instance)
    ...
    public async convertFullSeriesInfoToProviderLocalData(
        response: ISimklFullInfoSeriesResponse
    ): Promise<MultiProviderResult> {
        const provider = new ListProviderLocalData(response.ids.simkl, SimklProvider.instance)
