...
export default class SyncEpisodes {
    ...
    public getAllEpisodeThatAreOutOfSync(provider: ListProvider): Episode[] {
        ...
        for (const epPool of this.series.getEpisodeBindingPools()) {
    ...
    getSyncStatus(provider: ListProvider): SyncStatus {
        ...
        const maxEpisode =
            EpisodeHelper.getMaxEpisodeNrFromEpisodeBindingArray(
                this.series.getEpisodeBindingPools(),
    ...
    isSyncByEpisode(episode: Episode): boolean {
        ...
        for (const episodePool of this.series.getEpisodeBindingPools()) {
