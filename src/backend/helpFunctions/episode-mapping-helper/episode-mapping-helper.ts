...
export default class EpisodeMappingHelper {
    ...
    private applySeasonOnEpisode(detailedEpisode: Episode, targetSeason: Season | undefined) {
        if (detailedEpisode.season === undefined) {
            detailedEpisode.season = targetSeason;
        }
    }
