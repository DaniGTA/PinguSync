...
export default class ProviderHelper {
    ...
    public static hasSeriesProviderLocalData(series: Series, provider: ProviderLocalData): boolean {
        return (
            series
                .getAllProviderLocalDatas()
                .findIndex(
    ...
    public static hasSeriesProviderLocalDataWithSeason(
        series: Series,
    ...
    public static async requestUpgradeAllCurrentinfos(series: Series): Promise<ProviderLocalDataWithSeasonInfo[]> {
        ...
        for (const providerLocalData of providerLocalDatas) {
            try {
                if (
                    (providerLocalData && providerLocalData.infoStatus > ProviderInfoStatus.FULL_INFO) ||
                    !providerLocalData
                ) {
    ...
    public static isProviderTargetAchievFailed(
    ...
    public static async simpleProviderLocalDataUpgradeRequest(
        currentLocalDatas: ProviderLocalData[],
        providerInstance: ExternalInformationProvider
